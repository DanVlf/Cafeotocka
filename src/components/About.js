...
export default function AboutPage() {
  return (
    <div className="w-full flex flex-col min-[1800px]:flex-row bg-gray-200 px-5 sm:px-10 md:px-20 py-10 justify-center space-y-8 lg:space-y-0">
      {/* Left: Gallery */}
      ...
      {/* Right: Google Map and Description */}
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-start items-start space-y-8">
        ...
        {/* Google Map */}
        <div className="w-full h-64 sm:h-80 bg-gray-300 rounded-lg overflow-hidden">
          <iframe
